...
// ***********************************************************************
// <copyright file="ProgressEditorUITypeEditor.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.ProgressThematic.FormEditors
{
    ...
    ///     Note that this class is <b>NOT</b> meant to be invoked directly
    /// </remarks>
    public class ProgressEditor : System.Drawing.Design.UITypeEditor
    {
        /// <summary>
            ...
            object value)
        {
            ...
            {
                ProgressDialog dialog = new ProgressDialog((ProgressInput)value);
                //dialog.Show();

                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    return dialog.ProgressInput;
                }
            }
            return value;
        }
