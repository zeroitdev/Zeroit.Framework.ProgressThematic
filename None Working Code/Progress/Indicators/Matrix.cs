...
namespace Zeroit.Framework.ProgressThematic
{
    ...
    public partial class ThematicProgress
    {
        ...
        float MacOSX_Matrix_m_StartAngle = 0;
        float MacOSX_Matrix_m_AngleIncrement = 0;
        MacOSX_Direction MacOSX_Matrix_m_Rotation;
        ...
        public int MacOSX_Matrix_Interval
        {
            ...
            set
            {
                if (value > 0)
                {
                    ...
                    MacOSX_Matrix_m_Timer.Interval = value;
                }
                else
                {
        ...
        public Color MacOSX_Matrix_TickColor {
            get
            {
                return progressInput.MacOSX_Matrix_TickColor;
        ...
        public void ZeroitMacOSXMatrix()
        {
            ...
            MacOSX_Matrix_m_Timer = new System.Timers.Timer();
        ...
        void MacOSX_Matrix_OnTimerElapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (MacOSX_Matrix_Rotation == MacOSX_Direction.CLOCKWISE)
            {
                MacOSX_Matrix_m_StartAngle += MacOSX_Matrix_m_AngleIncrement;

                if (MacOSX_Matrix_m_StartAngle >= 360)
                    MacOSX_Matrix_m_StartAngle = 0;
            }
            else if (MacOSX_Matrix_Rotation == MacOSX_Direction.ANTICLOCKWISE)
            {
                MacOSX_Matrix_m_StartAngle -= MacOSX_Matrix_m_AngleIncrement;
        ...
        private void MacOSX_Matrix_Paint(PaintEventArgs e)
        {
            ...
            e.Graphics.RotateTransform(MacOSX_Matrix_m_StartAngle, System.Drawing.Drawing2D.MatrixOrder.Prepend);
            ...
            e.Graphics.RotateTransform(-MacOSX_Matrix_m_StartAngle, System.Drawing.Drawing2D.MatrixOrder.Append);
