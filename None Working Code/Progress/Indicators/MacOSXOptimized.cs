...
namespace Zeroit.Framework.ProgressThematic
{
    ...
    public partial class ThematicProgress
    {
        ...
        public int MacOSX_Optimized_Interval
        {
            ...
            set
            {
                ...
                if (value > 0)
                {
                    ...
                    MacOSX_Optimized_m_Timer.Interval = value;
                }
                else
                {
                    progressInput.MacOSX_Optimized_Interval = MacOSX_Optimized_DEFAULT_INTERVAL;
                    MacOSX_Optimized_m_Timer.Interval = MacOSX_Optimized_DEFAULT_INTERVAL;
                }
        ...
        public void ZeroitMacOSXOptimized()
        {
            ...
            //MacOSX_Optimized_StartAngle = 30;
            // Default number of Spokes in this control is 12
            //MacOSX_Optimized_SpokesCount = 12;
            ...
            MacOSX_Optimized_m_Timer = new System.Timers.Timer();
