...
namespace Zeroit.Framework.ProgressThematic
{
    ...
    public partial class ThematicProgress
    {
        ...
        //private Color CPv2_Color = Color.LightSeaGreen;
        //private Color CPv2_ColorEmpty = Color.LightGray;
        ...
        private void DrawProgress(Graphics g, Rectangle rect, float percentage)
        {
            ...
            //create pens to use for the arcs
            using (Pen progressPen = new Pen(Color.LightSeaGreen, CPv2_ProgressWidth))
            {
                using (Pen remainderPen = new Pen(Color.LightGray, CPv2_ProgressWidth))
                {
                    //set the smoothing to high quality for better output
