...
namespace Zeroit.Framework.ProgressThematic
{
    ...
    public partial class ThematicProgress
    {
        ...
        {
            get { return progressInput.MCEx_InnerShift; }
            set
            {
                progressInput.MCEx_InnerShift = value;
                Invalidate();
            }
        }
        ...
        public void ZeroitProgressMultiCoExtended()
        {
        ...
        private void MultiCoExtended_Paint(PaintEventArgs e)
        {
            ...
            Rectangle rect = new Rectangle(MCEx_CorrectShift, MCEx_CorrectShift, Width - MCEx_Shift, Height - MCEx_Shift);
            Rectangle coloredRectangle = new Rectangle(0, 0, Width - MCEx_RectShift, Height - MCEx_RectShift);
