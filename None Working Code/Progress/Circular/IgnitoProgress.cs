        ...
        private void Ignito_Paint(PaintEventArgs e)
        {
                ...
                case Ignito_drawMode.Solid:
                    switch (IG_OutterRotatingAngle)
                    {
                        case Ignito_outterRotatingAngle.Clockwise:
                            g.FillPie(new SolidBrush(IG_Colors[4]), new Rectangle(10, 10, Width - 20, Height - 20), AnimStartAngle, (this.Value / 100) * 360f);

                            g.DrawPie(outera, new Rectangle(10, 10, Width - 20, Height - 20), AnimStartAngle, (this.Value / 100) * 360f);
                ...
                case Ignito_drawMode.Gradient:
                    switch (IG_OutterRotatingAngle)
                    {
                        case Ignito_outterRotatingAngle.Clockwise:
                            ...
                            g.DrawPie(outergradienta, new Rectangle(10, 10, Width - 20, Height - 20), AnimStartAngle, (this.Value / 100) * 360f);
            ...
            switch (IG_DrawMode)
            {
                case Ignito_drawMode.Solid:
                    ...
                    switch (IG_InnerRotatingAnlge)
                    {
                        case Ignito_innerRotatingAngle.Clockwise:
                            g.DrawPie(outerb, new Rectangle(45, 45, Width - 90, Height - 90), AnimStartAngle, (this.Value / 100) * 360f);
                ...
                case Ignito_drawMode.Gradient:
                    ...
                    {
                        case Ignito_innerRotatingAngle.Clockwise:
                            g.DrawPie(outergradientb, new Rectangle(45, 45, Width - 90, Height - 90), AnimStartAngle, (this.Value / 100) * 360f);
