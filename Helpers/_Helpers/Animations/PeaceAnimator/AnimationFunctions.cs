...
namespace Zeroit.Framework.ProgressThematic.AnimationHelpers.WinFormAnimation
{
    ...
    public static class AnimationFunctions
    {
        ...
        public static float CircularEaseInOut(float t, float b, float c, float d)
        {
            t /= d/2;
            if (t < 1)
                return (float) (-c/2*(System.Math.Sqrt(1 - t*t) - 1) + b);
            t -= 2;
            return (float) (c/2*(System.Math.Sqrt(1 - t*t) + 1) + b);
        }
        ...
        {
            t /= d;
            return (float) (-c*(System.Math.Sqrt(1 - t*t) - 1) + b);
        }
        ...
        public static float CircularEaseOut(float t, float b, float c, float d)
        {
            t /= d;
            t--;
            return (float) (c*System.Math.Sqrt(1 - t*t) + b);
        }
        ...
        {
            return (float) (c*System.Math.Pow(2, 10*(t/d - 1)) + b);
        }
        ...
        public static float ExponentialEaseInOut(float t, float b, float c, float d)
        {
            t /= d/2;
            if (t < 1)
                return (float) (c/2*System.Math.Pow(2, 10*(t - 1)) + b);
            t--;
            return (float) (c/2*(-System.Math.Pow(2, -10*t) + 2) + b);
        }
        ...
        public static float EaseInExpo(float t, float b, float c, float d)
        {
            ...
            return c * (float)System.Math.Pow(2, 10 * (t / d - 1)) + b;
        ...
        public static float EaseInOutExpo(float t, float b, float c, float d)
        {
            ...
            t /= d / 2;
            if (t < 1) return c / 2 * (float)System.Math.Pow(2, 10 * (t - 1)) + b;
            t--;
        ...
        public static float EaseInOutCirc(float t, float b, float c, float d)
        {
            ...
            t /= d / 2;
            if (t < 1) return -c / 2 * (float)(System.Math.Sqrt(1 - t * t) - 1) + b;
            t -= 2;
        ...
        public static float ElasticEaseOut(float t, float b, float c, float d)
        {
            ...
            return (c * (float)System.Math.Pow(2, -10 * t) * (float)System.Math.Sin((t * d - s) * (2 * System.Math.PI) / p) + c + b);
        }
        ...
        public static float ElasticEaseIn(float t, float b, float c, float d)
        {
            ...
            return -(c * (float)System.Math.Pow(0.2f, 0.1f * (t -= 0.1f)) * (float)System.Math.Sin((t * d - s) * (0.2 * System.Math.PI) / p)) + b;
        }
        #endregion
        ...
        public static float ElasticEaseInOut(float t, float b, float c, float d)
        {
            ...
            if (t < 1)
                return -.5f * (c * (float)System.Math.Pow(2, 10 * (t -= 1)) * (float)System.Math.Sin((t * d - s) * (2 * System.Math.PI) / p)) + b;
            return c * (float)System.Math.Pow(2, -10 * (t -= 1)) * (float)System.Math.Sin((t * d - s) * (2 * System.Math.PI) / p) * .5f + c + b;
        }
