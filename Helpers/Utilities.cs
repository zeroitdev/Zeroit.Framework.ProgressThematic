...
namespace Zeroit.Framework.ProgressThematic.FormEditors.Utilities
{
    /// <summary>
    /// Class Draw.
    /// </summary>
    static class Draw
    {
        ...
        public static Point DegreesToXY(float degrees, float radius, Point origin)
        {
            ...
            xy.X = (int)(System.Math.Cos(radians) * radius + origin.X);
            xy.Y = (int)(System.Math.Sin(-radians) * radius + origin.Y);
