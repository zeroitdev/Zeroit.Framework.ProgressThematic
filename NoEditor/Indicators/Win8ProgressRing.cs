...
namespace Zeroit.Framework.ProgressThematic.WithoutEditor
{
    ...
    public partial class ThematicProgress
    {
        ...
        System.Timers.Timer WinRing_timer = null;
        ...
        public int Control_Height
        {
            ...
            set
            {
                int old_control_height = WinRing_control_height;

                WinRing_control_height = value;
                if (old_control_height != WinRing_control_height)
                {
        ...
        public Color WinRing_Indicator_Color
        {
            ...
            set
            {
                Color old_indicator_color = WinRing_indicator_color;

                WinRing_indicator_color = value;
                if (old_indicator_color != WinRing_indicator_color)
                {
                    WinRing_revise_background_graphic = true;
                    this.Invalidate();
                }
        ...
        public int WinRing_Refresh_Rate
        {
            ...
            set
            {
                int old_refresh_rate = WinRing_refresh_rate;
                bool timer_running = WinRing_timer.Enabled;

                WinRing_refresh_rate = value;
                if (WinRing_refresh_rate < 10)
                {
                    WinRing_refresh_rate = 10;
                }
                if (WinRing_refresh_rate > 200)
                {
                    WinRing_refresh_rate = 200;
                }
                ...
                WinRing_timer_interval = (double)WinRing_refresh_rate;
                ...
                if (old_refresh_rate != WinRing_refresh_rate)
                {
                    WinRing_revise_background_graphic = true;
                    this.Invalidate();
                }
