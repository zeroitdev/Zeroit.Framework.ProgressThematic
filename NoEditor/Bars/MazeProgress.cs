...
namespace Zeroit.Framework.ProgressThematic.WithoutEditor
{
    ...
    public partial class ThematicProgress
    {
        ...
        /// </summary>
        /// <value>
        /// 	The <c>AmazingProgressBar.Maze_GradientType</c> value indicating the type of Gradient used for coloring filled cells.
        /// </value>
        [Category("RectangularProgress Maze")]
        ...
        /// 	Only used if <c>Gradient</c> is not <c>AmazingProgressBar.Maze_GradientType.None</c>.
        /// </value>
        ...
        private void MarqueeUpdate()
        {
            ...
            {
                Maze_marqueeLength = Math.Max(PathLength / 6, 1);
                Maze_marqueePosition = -Maze_marqueeLength;
                Maze_marqueeTimer.Interval = Math.Max(Convert.ToInt32(MarqueeAnimationSpeed) / PathLength, 5);
        ...
        private void FillCells()
        {
            ...
            {
                startIndex = Math.Max(0, Maze_marqueePosition - Maze_marqueeLength);
                endIndex = Math.Min(PathLength - 1, Maze_marqueePosition + Maze_marqueeLength);
            }
            else
            {
    ...
    partial class ThematicProgress
    {
        /// <summary>
